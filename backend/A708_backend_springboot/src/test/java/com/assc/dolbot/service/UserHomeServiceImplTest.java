...
//
// 		when(homeRepository.findByRobotNumber(10)).thenReturn(home);
//
// 		doAnswer(invocation -> {
// 			UserHome entity = invocation.getArgument(0);
// 			entity.setUserHomeId(7);
// 			return null;
// 		}).when(userHomeRepository).save(userHomeDto.toEntity());
//
// 		// When
// 		userHomeService.addUserHome(userHomeDto);
//
// 		// Then
// 		verify(homeRepository).findByRobotNumber(10);
// 		assertEquals(1, userHomeDto.getHomeId());
// 	}
//
// 	@Test
